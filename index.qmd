...
We measured the voltage at two points in a resistor network to validate the behavior of the circuit. We found the ratio of voltages was: $0.6653\pm 0.0012$, very close to the expected value of $0.667$. We also measured the decay over time of the voltage on a capacitor. We used that to estimate the decay time constant and found that to be $\tau = 68.24 \pm 0.362\mathrm{~ms}$, close to the expected value of $\tau =66.67\mathrm{~ms}$.
...
We can simulate this experiment using a DC sweep simulation.
...
The statistics exercises for this project were to perform the curve fitting for the two experiments.

# 5. Conclusion

We performed two experiments 1. measurements on a voltage divider to validate the value of the ratio of the bottom resistor to the whole network and 2. to measure the time constant of an RC network.  We found the ratio of voltages for the voltage divider was: $0.6653\pm 0.0012$, very close to the expected value of $0.667$. We found the time constant of the RC circuit to be $\tau = 68.24 \pm 0.362\mathrm{~ms}$, close to the expected value of $66.67\mathrm{~ms}$.

The goal of this project was to become familar with all the tools we'll be using this semester in Laboratory Instrumentation and to make some real measurements, and analyze some real data. 
